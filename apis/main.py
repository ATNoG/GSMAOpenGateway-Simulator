...
# @Last Modified time: 2024-01-11 19:31:03
# coding: utf-8
...
device_status_app = FastAPI(
    ...
    description=(
        ...
        "the response.\n\n- via a subscription request - in this "
        ...
        "are several are managed in this API.\n\nFollowing event "
        ...
        "OFF to roaming ON \n\n- `org.camaraproject.device-status.v0."
        "roaming-off`"
        ": Event triggered when the device switch from roaming ON "
        "to roaming OFF \n\n- "
...
@device_status_app.exception_handler(RequestValidationError)
